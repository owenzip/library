            ...
            <div class="card">
                ...
                <form id="formBookInfo">
                    <div class="row form-group" style="margin-top: 50px;margin-left: 60px">
                        <input id="idSach" name="idSach" type="hidden" value="-1">
                        <div class="col-md-12 form-row">
                            ...
                            <div class="col-md-3">
                                <label>Tác giả</label>
                                <select id="idTacGia" name="idTacGia" type="text" class="form-control">
                                    <option selected="selected"></option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                <label>Thể loại</label>
                                <select id="idTheLoai" name="idTheLoai" type="text" class="form-control">
                                    <option selected="selected"></option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label>Nhà xuất bản</label>
                                <select id="idNhaXuatBan" name="idNhaXuatBan" type="text" class="form-control">
                                    <option selected="selected"></option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12 form-row" style="margin-top: 30px">
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="idNhaCungCap" name="idNhaCungCap" type="text" class="form-control">
                                    <option selected="selected"></option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12 form-row" style="margin-top: 30px">
                            <div class="col-md-2">
                                ...
                                <select id="idChatLuong" name="idChatLuong" type="text" class="form-control">
                                    <option selected="selected"></option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                <label>Tình trạng</label>
                                <select id="idTinhTrang" name="idTinhTrang" type="text" class="form-control">
                                    <option selected="selected"></option>
                                </select>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <select id="idBinhChon" name="idBinhChon" type="text" class="form-control">
                                    <option selected="selected"></option>
                                </select>
                            </div>
                            <div class="col-md-3">
